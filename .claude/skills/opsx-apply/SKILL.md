...
- **Guided implementation**: Claude guides you through each step
...
1. **Understanding**: Claude explains the task
...
[Claude reads all artifacts and current progress]
...
[Claude provides additional explanation]
[Shows code examples]
