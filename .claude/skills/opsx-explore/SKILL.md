...
2. **Ask questions**: Respond to Claude's questions to guide the exploration
...
- Ask Claude to explore specific files or patterns
- Request diagrams or visualizations
- Have Claude answer your questions about the codebase
