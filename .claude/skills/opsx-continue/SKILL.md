...
- **From Proposal to Spec**: Claude reads your proposal and helps write detailed specifications
- **From Spec to Design**: Claude understands requirements and suggests architecture
- **From Design to Tasks**: Claude breaks design into concrete implementation tasks
...
[Claude reads PROPOSAL.md and SPEC.md]
...
[Claude reads all prior artifacts]
...
2. **Review prior artifacts**: Claude will summarize them for you
